...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func setupScoreLabel() {
        ...
        bestScoreLabelNode.fontColor = UIColor.redColor()
        ...
        itemScoreLabelNode.fontColor = UIColor.blueColor()
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        ...
        let (_, other) = contact.bodyA.categoryBitMask < contact.bodyB.categoryBitMask ? (contact.bodyA, contact.bodyB) : (contact.bodyB, contact.bodyA)
        ...
        case scoreCategory:
            ...
            // 壁か地面と衝突した
        case wallCategory, groundCategory:
            print("GameOver")
        ...
        case itemCategory:
            ...
            let SoundAction: SKAction = SKAction.playSoundFileNamed("get.mp3", waitForCompletion: true)
            self.runAction(SoundAction);
            
            let removeitem = SKAction.removeFromParent()
            item.runAction(removeitem)
    ...
    func setupItem() {
        ...
        item.position = CGPoint(x: self.frame.size.width * 0.7, y:self.frame.size.height * 0.5)
        ...
        let itemwaitAnimation = SKAction.waitForDuration(2)
        let repeatAnimation = SKAction.repeatActionForever(SKAction.sequence([itemAnimation, itemwaitAnimation]))
        
        self.item.runAction(repeatAnimation)
